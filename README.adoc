...
[source,console]
----
C:\Users\horikawa kazuma\craftinginterpreters\java\lox01-VR-character-designer\codes>java com.craftinginterpreters.lox.Lox
> (1+2)*(4-5)/(8*9)-(6/5)
(- (/ (* (group (+ 1.0 2.0)) (group (- 4.0 5.0))) (group (* 8.0 9.0))) (group (/ 6.0 5.0)))
LEFT_PAREN ( null
NUMBER 1 1.0
PLUS + null
NUMBER 2 2.0
